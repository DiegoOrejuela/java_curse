...
public class _121_122_Cuadros_de_Dialogo {
	...
	private class Accion_botones implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource()==boton1){
				...
				JOptionPane.showMessageDialog(Lamina_Cuadros_Dialogos.this, "Ke pasa wey", "ke ves!", JOptionPane.WARNING_MESSAGE);
				...
				JOptionPane.showInputDialog(Lamina_Cuadros_Dialogos.this, "me vale vrgas!", "sigues ahí pinche?!", JOptionPane.ERROR_MESSAGE);
				...
				JOptionPane.showConfirmDialog(Lamina_Cuadros_Dialogos.this, "Pero que 'ergas!", "no mames", JOptionPane.YES_OPTION, JOptionPane.ERROR_MESSAGE);
				...
				String [] chuladas = { "no mames", "pinche Wey", "el vrgas", "un 100tifiko"};
				
				JOptionPane.showOptionDialog(Lamina_Cuadros_Dialogos.this, ":O", "Pero", 1, JOptionPane.QUESTION_MESSAGE, null, chuladas, null);
