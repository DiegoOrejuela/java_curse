...
public class Uso_empleado {
	...
	public static void main(String[] args) {
		...
		//Forma mejorada
			...
			Jefatura jefe_RH = new Jefatura ("Armor", 750000, 2000, 3, 23); //Polimorfismo y enlace diámico
			jefe_RH.setIncentivo(100000);
			misEmpleados [5] = jefe_RH;
			misEmpleados [6] = new Jefatura ("Pepito Pino", 700000,  2000,  12, 23);//Conversión (casting) de objetos. Refundición
			...
			método comparableTo en la clase empleado*/
			...
			empleado [] misEmpleados2 = new empleado [2];
				...
				for (empleado h : misEmpleados2) {
					...
					h = new empleado (JOptionPane.showInputDialog("Introduce el nombre del "
							...
							+ "año de alta")),  Integer.parseInt(JOptionPane.showInputDialog("Introduce el "
...
class empleado implements Comparable {
	...
	//Sobrecarga de constructores
		/*Objetivo: Queremos que cuando solo se pase nombre, se agrege por defecto
		 en las demás variables datos por defecto*/
	...
	public empleado (String nom) {
		...
		//Metodos getters
			...
			/*Método de la interfaz Comparable para ordenar la lista, junto con 
