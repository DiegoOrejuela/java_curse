...
class Marco_Barra extends JFrame{
	...
	public Marco_Barra(){
		...
		URL bolaAzul = Marco_Barra.class.getResource("recursos/Bola_Azul.png");
		
		Action accionAzul=new AccionColor("Azul", new ImageIcon(bolaAzul), Color.BLUE);
		
		Action accionAmarillo=new AccionColor("Amarillo", new ImageIcon( getClass().getResource("recursos/Bola_Amarilla.png")), Color.YELLOW);
		
		Action accionRojo=new AccionColor("Rojo", new ImageIcon(getClass().getResource("recursos/Bola_Roja.png")), Color.RED);
		
		Action salir = new AbstractAction ("Salir", new ImageIcon (getClass().getResource("recursos/Salir.png"))) {
